<div id="chatter">
    <div id="new_discussion">
        ...
        {{ Form::open(['id' => 'formTrackingReportSheet', 'data-url' => url('TrackingReportSheet')]) }}
        ...
        <div class="row">
            ...
            <div class="col-lg-6">
                <div id="field_tracking_report_sheet_status" class="form-group">
                    ...
                    <span class="text-danger">*</span>
                    {{ Form::select('tracking_report_sheet_status', [1=>'Pendiente',2=>'En Proceso',3=>'Levantado'], null,['id'=>'tracking_report_sheet_status', 'placeholder' => 'Estado...', 'class'=>'form-control']) }}
                    <div class="form-control-feedback"></div>
                </div>
            </div>
        </div>
