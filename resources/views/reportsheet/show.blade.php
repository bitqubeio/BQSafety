...
@section('title', 'Reporte: #' . $reportsheet->id)
                ...
                <div class="col-lg-7">
                    <div class="row">
                        ...
                        <div class="col-lg-6 text-right">
                            <a href="{{ url('/reportsheetPDF/'.$reportsheet->id) }}" class="btn btn-danger btn-sm"><i class="fa fa-file-pdf-o" aria-hidden="true"></i> Exportar a PDF</a>
                            <a href="{{ url('/reportsheet/create') }}" class="btn btn-create btn-sm"><i class="fa fa-plus" aria-hidden="true"></i> Nuevo</a>
                            <a href="{{ url('/reportsheet') }}" class="btn btn-secondary btn-sm"><i class="fa fa-list" aria-hidden="true"></i> Reportes</a>
                        </div>
                    </div>
