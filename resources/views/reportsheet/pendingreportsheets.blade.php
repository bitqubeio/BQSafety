    ...
    <section id="main">
        <div class="container-fluid">
            <div class="row">
                <div class="col-lg-12">
                    <div class="row">
                        <h1 class="col-lg-6"><i class="fa fa-file-text-o"></i>Reportes pendientes</h1>
            ...
            <div class="row my-4">
                <div class="col-lg-12">
                    <table class="table responsive table-bqsafety table-hover" id="grid-pendingreportsheets"
...
@section('javascript')
    ...
    <script>
        $(document).ready(function () {
            $('#grid-pendingreportsheets').DataTable({
                "bAutoWidth": false,
                "order": [[0, "desc"]],
                "processing": true,
                "serverSide": true,
                "ajax": "{{ url('api/listPendingReportSheets') }}",
                "columns": [
