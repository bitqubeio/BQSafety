                        ...
                        <div class="card-block">
                            ...
                            {{ Form::open(array('route' => 'roles.store')) }}
                                ...
                                <div class="form-group{{ $errors->has('name') ? ' has-danger' : '' }}  row">
                                    <label for="name" class="col-lg-2 col-form-label text-lg-right">Nombre:
                                        <span class="text-danger">*</span>
                                    </label>
                                    <div class="col-lg-10">
                                        {!! Form::text('name', null, array('placeholder' => 'Nombre','class' => 'form-control','autofocus'=>'autofocus', 'autocomplete'=>'off')) !!}
                                        @if ($errors->has('name'))
